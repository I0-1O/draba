...
**Last updated:** 2026-07-09 (`/review-phase 16.1` — 0 blockers; all suggestions fixed same session: backup dir/files now 0700/0600, `BackupSchedule` schema deferred to 16.2, `SetKeepLast` removed, `writable:false` test added. Next: 16.2 scheduler.)
